...
- [📔 Gün 1](#-gün-1)
  ...
  - [Qurmaq](#qurmaq)
    ...
    - [Brauzer](#brauzer)
      - [Google Chrome-un quraşdırılması](#google-chromeun-quraşdırılması)
      - [Google Chrome konsol açılışı](#google-chrome-konsol-açılışı)
      - [Brauzer konsolunda kodun yazılması](#writing-code-on-browser-console)
        - [Console.log](#consolelog)
        - [Console.log - Çox arqumentli ](#consolelog-with-multiple-arguments)
        - [Şərhlər](#comments)
        - [Sintaksis «Syntax»](#syntax)
      - [Hesablama](#arithmetics)
    - [Kod redaktoru](#code-editor)
      - [Visual Studio Code yüklənməsi](#installing-visual-studio-code)
      - [VS Code necə istifadə edilir](#how-to-use-visual-studio-code)
  - [Veb səhifəyə JavaScript əlavə edilməsi](#adding-javascript-to-a-web-page)
    - [Sətir içi «Inline» skript](#inline-script)
    - [Daxili «Internal» skript](#internal-script)
    - [Xarici «External» skript](#external-script)
    - [Çoxlu xarici «Multiple External» skript](#multiple-external-scripts)
  - [Məlumat növlərinə «Data Types» giriş](#introduction-to-data-types)
    - [Rəqəmlər «Numbers»](#numbers)
    - [Sətirlər «Strings»](#strings)
    - [Booleanlar(məntiqi) növ «boolean»](#booleans)
    - [Qeyri-müəyyən «undefined»](#undefined)
    - [Boş dəyər «null»](#null)
  - [Məlumat növlərinin yoxlanılması](#checking-data-types)
  - [Yenə şərhlər](#comments-again)
  - [Dəyişənlər «Variables»](#variables)
- [💻 Gün 1: Məşqlər](#-day-1-exercises)
